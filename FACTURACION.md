...
BOE). Recoge lo que dicen las normas y lo que hace hoy el programa.
...
responsable. El motor de gestión sobre el que está construido, con `l10n_es`,
**no aporta por sí solo** ese cumplimiento.
...
- **Antes de esas fechas** hay que decidir una de estas tres vías, con la
  gestoría y con quien mantenga el programa:
  1. Adoptar un módulo de terceros de VERI\*FACTU compatible con este programa,
     con declaración responsable del fabricante.
  2. Implementarlo en este módulo, con su declaración responsable.
  3. Emitir a través de un sistema ya conforme.
