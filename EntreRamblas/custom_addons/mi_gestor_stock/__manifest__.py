{
    ...
    "data": [
        ...
        "data/mgs_purchase_data.xml",
        "data/mgs_expiry_data.xml",
        "views/mgs_config_views.xml",
        "views/mgs_hardware_job_views.xml",
        "views/mgs_reception_views.xml",
        "views/mgs_purchase_views.xml",
        "views/mgs_purchase_forecast_views.xml",
        "views/mgs_lot_views.xml",
        "views/mgs_expiry_views.xml",
        ...
        "views/mgs_bouquet_recipe_views.xml",
        "views/mgs_pricelist_campaign_views.xml",
